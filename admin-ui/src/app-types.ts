...
export type ScreenKey = "dashboard" | "requests" | "materials" | "calculator" | "settings";
...
export const navigation: Array<{ key: ScreenKey; label: string; note: string }> = [
  { key: "dashboard", label: "Дашборд", note: "Общая картина по базе и объектам" },
  { key: "requests", label: "Заявки", note: "Черновики, подтверждения и детали" },
