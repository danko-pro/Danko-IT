import { formatArea, formatMoney, trimFloat } from "./calculator-shared";
import type { WallFinishStageReadyProps } from "./calculator-wall-finish-stage-types";

type WallFinishStageTechMapProps = Pick<WallFinishStageReadyProps, "wallFinishSelectedTechRooms">;

export function WallFinishStageTechMap(props: WallFinishStageTechMapProps) {
  if (!props.wallFinishSelectedTechRooms.length) {
    return null;
  }
