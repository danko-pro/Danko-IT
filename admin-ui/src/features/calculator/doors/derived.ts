import { getDoorMaterialSpecTitle, getDoorWorkSpecTitle } from "./";
import type { CalculatorDoorSpecItem, CalculatorDoorsSummary, CalculatorProjectDetail, CalculatorProjectDoor } from "./";
