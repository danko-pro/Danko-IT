...
export const PLUMBING_SEED: CatalogItem[] = [
  ...
  row(
    "kitchen-faucet-c",
    "Смеситель кухонный — пакет C",
    "kitchenFaucetC; требует уточнения",
    "шт",
    2000,
    1000,
    500,
  ...
  row("kitchen-faucet-b", "Смеситель кухонный — пакет B", "kitchenFaucetB", "шт", 2500, 1300, 500, 12000, "Кухня", "код"),
  row(
    "kitchen-faucet-a",
    "Смеситель кухонный — пакет A",
    "kitchenFaucetA; требует уточнения",
    "шт",
    3000,
    1500,
    500,
  ...
  row(
    ...
    "kitchenSinkBowlC; требует уточнения",
    "шт",
    0,
    0,
    0,
  ...
  row(
    "kitchen-sink-bowl-b",
    "Мойка кухонная — пакет B",
    "kitchenSinkBowlB; требует уточнения",
    "шт",
    0,
    0,
    0,
  ...
  row(
    "kitchen-sink-bowl-a",
    "Мойка кухонная — пакет A",
    "kitchenSinkBowlA; требует уточнения",
    "шт",
    0,
    0,
    0,
  ...
  row(
    "ppr-d20-outlet",
    "Выход / подключение PPR d20",
    "материал; ППР колено настенное РВ d20×1/2; 6 шт. на водяную точку; УТ-1107/1108/1109",
    "шт",
    0,
    121.28,
    0,
  ...
  row(
    "ppr-d20-fitting",
    "Фитинг / поворот PPR d20",
    "материал; ППР колено 90° d20; 6 шт. на водяную точку; УТ-1107/1108/1109",
    "шт",
    0,
    10.05,
    0,
    ...
    priceClassVariants: [
      {
        ...
        label: "Пакет C",
        items: [
          { atomicItemId: "kitchen-faucet-c", quantity: 1 },
          { atomicItemId: "kitchen-sink-bowl-c", quantity: 1 },
        ],
      },
      {
        id: "b",
        label: "Пакет B",
        items: [
          { atomicItemId: "kitchen-faucet-b", quantity: 1 },
          { atomicItemId: "kitchen-sink-bowl-b", quantity: 1 },
        ],
      },
      {
        id: "a",
        label: "Пакет A",
        items: [
          { atomicItemId: "kitchen-faucet-a", quantity: 1 },
          { atomicItemId: "kitchen-sink-bowl-a", quantity: 1 },
        ],
      },
    ],
    items: [
