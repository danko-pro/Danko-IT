...
from supply_bot.admin_api.app_routes_calculator_core import register_calculator_core_routes
from supply_bot.admin_api.app_routes_calculator_doors import register_calculator_door_routes
from supply_bot.admin_api.app_routes_calculator_flooring import register_calculator_flooring_routes
from supply_bot.admin_api.app_routes_calculator_wall_finish import register_calculator_wall_finish_routes
from supply_bot.admin_api.app_routes_calculator_warm_floor import register_calculator_warm_floor_routes
...
def register_calculator_routes(
    ...
    *,
    ...
    # Этот файл теперь только собирает calculator API из независимых route-групп.
