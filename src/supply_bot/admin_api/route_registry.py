...
from supply_bot.admin_api.schemas import (
    ...
    CalculatorFlooringCatalogAssemblyReplacePayload,
...
def register_admin_routes(app: FastAPI) -> None:
    ...
    register_calculator_routes(
        ...
        calculator_flooring_assembly_item_payload_model=CalculatorFlooringAssemblyItemPayload,
        calculator_flooring_catalog_assembly_replace_payload_model=CalculatorFlooringCatalogAssemblyReplacePayload,
